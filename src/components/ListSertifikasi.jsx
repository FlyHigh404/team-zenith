                    ...
                    <div key={item.id} className="flex items-center justify-between bg-white px-6 py-4 rounded-xl shadow-sm border border-gray-100">
                        ...
                        <div className='p-2'>
                            <button
                                ...
                                onClick={() => document.getElementById(`detailModal-${item.id}`).showModal()}
                            >
                                Lihat Detail
                            </button>
                        </div>
                        ...
                        <dialog id={`detailModal-${item.id}`} className="modal">
                            <div className="modal-box w-9/12 max-w-2xl">
                                <div className='flex justify-between'>
                                    <div className='flex gap-4'>
                                        ...
                                        <div className='py-1'>
                                            ...
                                            <p className="text-md">{item.bidang}, {item.keahlian}</p>
                                        </div>
                                    </div>
                                ...
                                <div className="modal-action flex justify-between">
                                    <button className="btn text-gray-400" type="button"
                                        onClick={() => document.getElementById(`editModal-${item.id}`).showModal()}>
                                        Edit
                                    </button>
