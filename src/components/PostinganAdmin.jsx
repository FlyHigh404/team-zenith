...
import { FaHeart, FaRegHeart, FaRegComment, FaRegPaperPlane, FaEye, FaEllipsisVertical, FaPlus, 
        FaPenToSquare, FaShareNodes, FaTrash, FaImages, FaFileLines, FaLink } from "react-icons/fa6";
                ...
                <dialog id="modalPostingan" className="modal">
                    <div className="modal-box rounded-xl shadow-lg p-4">
                        ...
                        <textarea
                            ...
                            className="w-full outline-none resize-none mt-4 text-sm min-h-[80px] max-h-[300px]"
                        />
                        ...
                        <div className="flex flex-row gap-4 items-start">
                            ...
                            <div className="relative">
                                <div
                                    ...
                                    className="flex cursor-pointer select-none mt-1"
                                >
                                    <FaEllipsisVertical />
                                </div>
                ...
                <div className="flex flex-row flex-wrap justify-between border border-gray-300 border-t-0 rounded-b-xl px-4 py-2">
                    <div className="flex flex-row gap-2">
                        <button 
                            ...
                            className="flex flex-row gap-1.5 items-center p-2 bg-white dark:bg-[#659BB0] rounded-md hover:bg-gray-100"
                        >
