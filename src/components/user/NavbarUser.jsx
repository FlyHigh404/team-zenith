...
import { FaMoon, FaBell, FaSearch, FaUserCircle, FaAngleDown, FaUser, FaChartPie, FaCog, FaSignOutAlt, FaBookmark } from 'react-icons/fa'
      ...
      ${isScrolled ? 'lg:bg-white lg:shadow-md bg-white dark:bg-[#1D232A]/50' : 'bg-white dark:bg-[#1D232A]'} font-sans sticky z-30 `}>
            ...
            <div className="flex justify-between items-center px-6 md:px-20 py-2 shadow-sm max-w-full mx-auto">
                ...
                <ul className="hidden lg:flex space-x-12 text-gray-700 font-medium">
                    ...
                    <li className="hover:text-gray-900 cursor-pointer text-base"><a href="#pekerjaan">Pekerjaan</a></li>
                ...
                <div className="flex items-center gap-3 relative">
                    ...
                    <div className="relative">
                        ...
                        >
                            <FaUserCircle className="text-sky-300 text-3xl" />
                            <span className="text-base font-semibold text-black">Farizah Farhana</span>
                            <FaAngleDown />
                        </div>
                        ...
                        {dropdownOpen && (
                            <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border-gray-500">
                                <div className="p-4 border-b-2 border-gray-300 flex">
                                    ...
                                    <div className='ml-3'>
                                        <div className="text-black font-semibold">Farizah Farhana</div>
                                        <div className="text-sm text-black font-light">farizahaja@gmail.com</div>
                                    </div>
                                ...
                                <ul className="p-2">
                                    ...
                                    <NavLink to="#" className="flex items-center gap-2 p-3 rounded-lg hover:bg-gray-100 text-black">
                                        <FaChartPie /><span>Lamaran</span>
                                    </NavLink>
                                    <NavLink to="#" className="flex items-center gap-2 p-3 rounded-lg hover:bg-gray-100 text-black">
                                        <FaBookmark /><span>Disimpan</span>
                                    </NavLink>
                                    <NavLink to="#" className="flex items-center gap-2 p-3 rounded-lg hover:bg-gray-100 text-black">
