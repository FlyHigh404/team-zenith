                    ...
                    <div className="modal-box">
                        ...
                        <div className="flex flex-row flex-wrap justify-between">
                            <div className="flex flex-row gap-3">
                                ...
                                {/* <button 
                                    type="button"
                                    // onClick={() => toogleConnect(post.id)}
                                    className="flex flex-row gap-2 items-center p-2 bg-white dark:bg-[#659BB0] rounded-md hover:bg-gray-100 cursor-pointer"
                                >
                                    <FaCamera/>
            ...
            <div className="grid grid-cols-3 mt-10 gap-1">
                <div className='flex flex-col col-span-2 p-4'>
                    <div className="flex flex-row gap-1 items-center">
                        <h2 className="font-semibold text-xl">ANADO</h2>
                        <img src={badgeAdmin} alt="Badge Admin" className="w-6" />
                    </div>
                    <p className="mt-1">Akun resmi ANADO</p>
                        ...
                        <dialog id="modalProfil" className="modal">
                            <div className="modal-box">
                                ...
                                <div className="my-2 space-y-2">
                                    {/*Ubah Foto Profil*/}
                                    {/* <div>
                                        <label className="font-medium text-sm">Foto Profil</label>
                                        <input 
                                            type="file"
                                            accept="image/*"
                                            className="file-input file-input-bordered w-full mt-1.5 rounded-lg"
                                        />
                                    </div> */}
                                    {[
                ...
                <div className="flex flex-col col-span-1 p-4">
                    {/* <div className="flex flex-row gap-1 mt-2">
                        <div className="bg-black w-4 h-4 rounded-full mt-1"></div>
                        <div className="flex flex-col ml-2">
                            <p className="font-semibold">Kemampuan</p>
                            <p className="">(kemampuan)</p>
                        </div>
                    </div> */}
