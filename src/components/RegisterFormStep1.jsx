      ...
      <form className="mt-5 md:mt-10 lg:mt-5" onSubmit={handleNext}>
        <div className="mb-4 md:mb-7 lg:mb-4">
          ...
          <input
            ...
            className="bg-gray-50 dark:bg-[#1D232A] dark:text-gray-300 border border-gray-300 text-gray-900 text-sm placeholder:text-sm dark:placeholder:text-[#A5A5A5] rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
            required
          />
        </div>
