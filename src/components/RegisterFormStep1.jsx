...
const RegisterFormStep1 = ({ formData, setFormData, setStep }) => {
    ...
    return (
        <div className="py-3 md:py-10 lg:py-5">
            ...
            <p className="text-sm md:text-base mt-1 font-medium">Jelajahi lebih banyak tentang Unedo, buat akun mu sekarang!</p>
            <form className="mt-5 md:mt-10 lg:mt-5" onSubmit={handleNext}>
                <div className="mb-4 md:mb-7 lg:mb-4">
                    ...
                    <input type="text" name="nama" value={formData.nama} onChange={handleChange} placeholder="Masukkan nama Anda" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm placeholder:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                </div>

                <div className="mb-4 md:mb-7 lg:mb-4">
                    <label className="block text-sm md:text-base lg:text-sm font-medium mb-1">Username</label>
                    <input type="text" name="username" value={formData.username} onChange={handleChange} placeholder="Buat nama pengguna Anda" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm placeholder:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                </div>
