    ...
    <div className="border-gray-300 w-full border rounded-2xl bg-white p-4 flex-1 px-6 py-8">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="relative">
          <input type="text" placeholder="Cari Koneksi" className="pl-4 pr-10 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-sky-500" />
          ...
          koneksiData.map((user) => (
            <div key={user.id} className="flex gap-3 items-start bg-white border border-gray-300 rounded-xl p-3 shadow-sm">
              ...
              <div className="flex gap-2">
                <button className="text-md border text-sky-500 px-2 py-2 rounded">
                  <FaTelegramPlane />
                </button>
                <button className="text-md border text-red-500 px-2 py-2 rounded">
                  <FaXmark />
                </button>
              </div>
            </div>
