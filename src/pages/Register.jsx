    ...
    return (
        <div className="flex md:flex-col lg:flex-row h-screen">
            <div className="flex-grow w-full lg:w-[55%] flex flex-col justify-start px-6 md:px-20 overflow-y-auto">
                {step === 1 ? (
                    <RegisterFormStep1 formData={formData} setFormData={setFormData} setStep={setStep} />
                ) : (
                    <RegisterFormStep2 formData={formData} setFormData={setFormData} setStep={setStep} navigate={navigate} />
                )}
            </div>
