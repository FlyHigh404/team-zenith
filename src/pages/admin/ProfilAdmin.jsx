...
const ProfilAdmin = () => {
    return (
        <div className='bg-[#F5F5F5] flex md:flex-col lg:flex-row gap-x-8'>
            <div className="flex-grow w-full lg:w-[67%] flex flex-col justify-start md:pl-20">
                <InformasiProfil />
                <PostinganAdmin />
            </div>
            <div className="flex-grow w-full lg:w-[33%] flex flex-col justify-start md:pr-20">
                <InformasiKontak />
                <PekerjaanTerbaru />
                <RekomendasiKoneksi />
            </div>
